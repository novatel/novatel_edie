...
void py_common::init_common(nb::module_& m)
{
    ...
    nb::class_<SatelliteId>(m, "SatelliteId")
        ...
        .def("__repr__",
             [](SatelliteId id) { return nb::str("SatelliteId(prn={!r}, frequency_channel={!r})").format(id.usPrnOrSlot, id.sFrequencyChannel); });
    ...
    nb::enum_<novatel::edie::INPUT_FORMAT>(m, "HEADER_FORMAT", nb::is_arithmetic(), "Formats for novatel headers.")
        .value("UNKNOWN", novatel::edie::INPUT_FORMAT::UNKNOWN)
        .value("BINARY", novatel::edie::INPUT_FORMAT::BINARY)
        .value("ASCII", novatel::edie::INPUT_FORMAT::ASCII)
        .value("ABB_ASCII", novatel::edie::INPUT_FORMAT::ABB_ASCII)
        .value("NMEA", novatel::edie::INPUT_FORMAT::NMEA)
        .value("JSON", novatel::edie::INPUT_FORMAT::JSON)
        .value("ALL", novatel::edie::INPUT_FORMAT::ALL)
