...
void py_oem::init_novatel_filter(nb::module_& m)
{
    nb::class_<oem::PyFilter>(m, "Filter")
        ...
        .def("add_message_id", nb::overload_cast<uint32_t, DECODE_FORMAT, uint8_t>(&oem::PyFilter::IncludeMessageId), "id"_a,
             "format"_a = DECODE_FORMAT::ALL, "source"_a = NULL_SIBLING_ID,
             R"doc(
        ...
        .def("extend_message_ids", nb::overload_cast<std::vector<std::tuple<uint32_t, DECODE_FORMAT, uint8_t>>&>(&oem::PyFilter::IncludeMessageId),
             "ids"_a,
             R"doc(
        ...
        .def("add_message_name", nb::overload_cast<std::string_view, DECODE_FORMAT, uint8_t>(&oem::PyFilter::IncludeMessageName), "name"_a,
             "format"_a = DECODE_FORMAT::ALL, "source"_a = NULL_SIBLING_ID,
             R"doc(
        ...
        .def("extend_message_names",
             nb::overload_cast<std::vector<std::tuple<std::string, DECODE_FORMAT, uint8_t>>&>(&oem::PyFilter::IncludeMessageName), "names"_a,
             R"doc(
