...
void init_common_message_database(nb::module_& m)
{
    ...
    nb::class_<PyMessageDatabase>(m, "MessageDatabase")
        ...
        .def("append_messages", &PyMessageDatabase::AppendJsonDbMessages, "file_path"_a, "generate_mappings"_a = true)
        .def("append_enumerations", &PyMessageDatabase::AppendJsonDbEnumerations, "file_path"_a, "generate_mappings"_a = true)
